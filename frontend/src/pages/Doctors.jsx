...
const Doctors = () => {
  const { speciality } = useParams(); // Getting speciality from URL parameters thats beein setup in routes of appjsx

  const {doctors} = useContext(AppContext);

  const [filterDoc, setFilterDoc] = useState([]);

  const [showFilter, setShowFilter] = useState(false); ///to show and hide filter options on small screen
